		...
		<div id="section_wrap">
			...
			<div class="create_account_form">
				<form action="<c:url value='/admin/member/createAccountConfirm' />" name="create_account_form" method="post">
				 <!-- name="create_account_form" : form을 식별하기 위한 이름 -->
					...
					<input type="text" name="a_m_name" placeholder="INPUT ADMIN NAME.">
					<!-- name 속성 중요 데이터베이스와 연동할 때 굉장히 중요하기 때문에 주의해줘야함 -->
					<!--  name = vo멤버필드 = 컬럼이름 세개가 같아야함 -->
					 <br>
